...
import flightRoutes from './modules/itinerary/flight.routes';
import routeAlertRoutes from './modules/alerts/routeAlert.routes';
import expenseRoutes from './modules/gullak/expense.routes';
...
app.use('/api/expenses', familyPinMutationsOnly, expenseRoutes);
app.use('/api/feed', familyPinMutationsOnly, feedRoutes);
app.use('/api/media', familyPinMutationsOnly, mediaRoutes);
app.use('/api/train', trainRoutes);
app.use('/api/flight', flightRoutes);
app.use('/api/alerts', routeAlertRoutes);
