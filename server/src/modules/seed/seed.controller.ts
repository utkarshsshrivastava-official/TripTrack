...
export const SEED_SEGMENTS = [
  ...
  },
  {
    ...
    departureTime: new Date("2026-09-26T06:00:00+05:30"),
    arrivalTime: new Date("2026-09-26T16:00:00+05:30"),
    mode: "CAB_HILLS",
    status: "UPCOMING",
    logistics: {
  ...
  },
  {
    ...
    arrivalTime: new Date("2026-09-27T16:00:00+05:30"),
    mode: "CAB_HILLS",
    status: "UPCOMING",
    logistics: {
  ...
  },
  {
    ...
    departureTime: new Date("2026-09-28T08:30:00+05:30"),
    arrivalTime: new Date("2026-09-28T16:30:00+05:30"),
    mode: "CAB_HILLS",
    status: "UPCOMING",
    logistics: {
      serviceName: "Dedicated Mountain Cab",
  ...
  },
  {
    ...
    departureTime: new Date("2026-10-02T09:00:00+05:30"),
    arrivalTime: new Date("2026-10-02T16:00:00+05:30"),
    mode: "FLIGHT",
    status: "UPCOMING",
    logistics: {
