...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 bg-slate-950/90 backdrop-blur-xl border-b border-slate-800/80 px-3.5 pt-safe pb-2.5 transition-all">
      <div className="flex items-center justify-between gap-2 max-w-md mx-auto h-12">
        ...
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <div className="flex items-center gap-2 min-w-0">
            <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-amber-600 to-amber-400 flex items-center justify-center shadow-sm shadow-amber-500/20 shrink-0">
              <Mountain className="w-4 h-4 text-slate-950" />
            </div>
            <div className="min-w-0">
              <div className="flex items-center gap-1.5">
                <h1 className="text-sm font-black tracking-tight text-white leading-none truncate">
                  TripTrack
                </h1>
                <span className="text-[9px] font-mono px-1 py-0.5 rounded bg-slate-800/90 text-amber-400 border border-slate-700/80 font-bold leading-none">
                  '26
                </span>
              </div>
              <span className="text-[10px] text-slate-400 block leading-tight font-medium truncate">
                Badrinath Dham
              </span>
            </div>
          </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <div className="flex items-center p-0.5 rounded-lg bg-slate-900/90 border border-slate-800 text-[11px] font-bold shadow-xs">
            <button
          ...
          <button
            ...
            disabled={isSyncing}
            className={`tap-active h-8 px-2 rounded-lg flex items-center justify-center gap-1.5 border text-xs font-semibold transition-all ${
              isOnline
